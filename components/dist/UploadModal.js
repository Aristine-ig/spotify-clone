...
var UploadModal = function () {
    var _a = react_1.useState(), isLoading = _a[0], setIsLoading = _a[1];
    ...
    return (React.createElement(Modal_1["default"], { title: "Add a song ", description: "Upload an mp3 file", isOpen: uploadModal.isOpen, onChange: onChange },
        React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
            React.createElement(Input_1["default"], __assign({ id: "title", disabled: isLoading }, register('title', { required: true }), { placeholder: "Song title" })))));
};
